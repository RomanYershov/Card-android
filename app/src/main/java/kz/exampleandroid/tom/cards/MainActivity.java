...
public class MainActivity extends AppCompatActivity {
    ...
    private void initialNews() {
        ...
        newsList.add(new News("Новости", getString(R.string.text1), R.mipmap.panda));
        newsList.add(new News("Разное", getString(R.string.text2), R.mipmap.minon));
        newsList.add(new News("Цветы", getString(R.string.text1), R.mipmap.flawer));
        newsList.add(new News("Разное", getString(R.string.text3), R.mipmap.minon));
    }
}
